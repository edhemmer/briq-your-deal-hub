...
const rentalBaseOptional: UnderwritingInputId[] = ["asking_price", "closing_costs", "initial_repairs", "initial_reserves", "bedroom_count", "bathroom_count", "year_built", "lot_size", "other_income", "credit_loss", "utilities", "other_operating_expenses", "vacancy_rate"];
...
function evaluateCondition(rule: ConditionalRequirementRule, value?: UnderwritingInputValue) {
  const actual = value?.canonicalValue;
