          ...
          <div className="mt-5 rounded-md border border-destructive/20 bg-destructive/[0.04] p-3 flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-[11px] text-muted-foreground mt-1 leading-relaxed">
                Sum of priced downside across {analysis.totalExposure.count} concern{analysis.totalExposure.count === 1 ? "" : "s"}. See the Risk tab for per-item ranges. Caps and savings excluded.
              </p>
            </div>
          </div>
        )}
      ...
      {analysis.missingInputs.length > 0 && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
            <CardContainer className="p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-semibold text-foreground">Pros for {analysis.perspective}</h3>
            ...
            <CardContainer className="p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-semibold text-foreground">Cons for {analysis.perspective}</h3>
                      ...
                      <div className="flex items-start justify-between gap-2 mb-1">
                        ...
                        <div className="flex items-center gap-1 shrink-0 flex-wrap justify-end">
                          ...
                          {c.confidenceAdjusted && (
                            <Badge variant="outline" className="text-[9px] uppercase tracking-wide bg-background/60">Adj.</Badge>
                          )}
        ...
        <TabsContent value="negotiation" className="mt-0">
          {analysis.negotiation.length > 0 ? (
            ...
            <CardContainer className="p-5 mb-5">
              <p className="text-xs text-muted-foreground">No negotiation moves recommended.</p>
            </CardContainer>
          )}
