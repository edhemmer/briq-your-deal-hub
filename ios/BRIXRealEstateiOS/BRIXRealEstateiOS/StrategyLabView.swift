            ...
            VStack(spacing: 16) {
                if appState.authState.isSignedIn == false {
                    SignInRequiredCard(
                        ...
                        message: "Sign in to review deal records, missing inputs, strategy fit, and backend-generated recommendations."
                    )
                } else if let deal = appState.selectedDeal {
                    BrixCard {
                        VStack(alignment: .leading, spacing: 12) {
                            SectionHeader(title: "DealIQ", subtitle: "Underwriting is generated by BRIX backend services.", symbol: "chart.bar.xaxis")
                            Text(deal.title)
                                .font(.title2.bold())
                    ...
                    if let snapshot = appState.selectedDecisionSnapshot {
                        ...
                        EmptyOperatingState(
                            ...
                            message: "Run or refresh DealIQ on the backend to generate recommendations, scenarios, and strategy comparisons for this property.",
